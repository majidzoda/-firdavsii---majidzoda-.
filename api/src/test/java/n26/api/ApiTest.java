...
public class ApiTest extends TestCase{
	 ...
	 * Test Case: 2.3
	 * This method tests "types" endpoint with GET request method
	 * and with wrong parameter "types":
	 * 
	 * types:	food
	 * 
	 * Expectation: 
	 * status 			code 401,
	 * response 		{"error":"No transactions found with type: food"}
	 */
	@Test
	public void testTypes_with_wrong_types() {
		...
		.then()
		.statusCode(401).assertThat()
		.body("error", equalTo("No transactions found with type: "+random_type));
	}
	 ...
	 * Test Case: 3.3
	 * This method tests "sum" endpoint with GET request method
	 * and with wrong transaction_id:
	 * 
	 * transaction_id	100
	 * 
	 * Expectation: 
	 * status 			code 200,
	 * response 		{"error": "No transaction found with transaction_id: 100"}
	 */
	@Test
	public void testSum_with_wrong_transaction_id() {
		long random_transaction_id = 100;
		given()
		.headers( "X-HTTP-Method-Override",  "GET")
		.formParam("transaction_id", random_transaction_id)
